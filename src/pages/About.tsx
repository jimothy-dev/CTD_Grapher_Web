    ...
    <div className="about stack">
      ...
      <div className="card">
        ...
        <ul>
          ...
          <li>On a section, everything between stations is interpolated: a shape-preserving curve through the casts at every depth, objective analysis (Gauss-Markov), or straight lines. Ocean Data View does this in more depth; this is the no-install, shareable version.</li>
