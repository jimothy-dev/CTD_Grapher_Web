...
export default function PlotCard({ data, layout, filename, height, theme, autoTitle, title, showTitle, onTitle, note, width, onWidth, onRemove }: Props) {
